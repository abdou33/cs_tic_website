...
<style>
    ...
    @font-face {
            ...
            src: url(assets/fonts/Passion_One/PassionOne-Bold.ttf);
    }
    *{
...
<html>
    ...
    <head>
        ...
        <div class="navbar">
            <a href="index.php"><img class="logo" src="assets/media/logo.png" ></a>
            <div class="left-options">
                <div id="langdiv">
                    ...
                    <div class="dropdown-lang">
                        <p href="" onclick="change_lang('ar')"><img src="assets/lang/alg.png">العربية</p>
                        <p href="" onclick="change_lang('en')"><img src="assets/lang/uk.png"> english</p>
                        <p href="" onclick="change_lang('fr')"><img src="assets/lang/france.png"> français</p>
                    </div>
                </div>
